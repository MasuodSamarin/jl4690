...
#define SUPPORT_OFF_FM_DOT_ICON
#define SUPPORT_MUTE_STATE_OFF_USB_SD_ICON
#define SUPPORT_HI_I_SHOW_LEFIT
#define SUPPORT_STANDBY_NO_SHOW_OFF
...
//#define SUPPORT_LED_BLUE_BT_ICON_ALWAY_LIGHT
#define SUPPORT_BT_NO_USE_PLAY_PAUSE_ICON
#define SUPPORT_TY_8848_OFF_ICON
#endif
...
// 面板按键10+和stop功能互换，0欧，1K，2K都改为播放暂停功能。
#define adk_use_10k_12key_mode_tianyin_2
...
#ifdef IR_TY_THREE_GENERAL_TY_00FF_HD7369_807F_30CF_27KEY
//-------------------------------------------
...
#define  SUPPORT_FM_SCAN_FINISH_DAC_MUTE // 搜台完成内部mute 1s


//#define SUPPORT_MODE_MAX_VOL_SINGLE_ADJUST
//#define SUPPORT_TIANYIN_AUX_VOL_ADJUST
