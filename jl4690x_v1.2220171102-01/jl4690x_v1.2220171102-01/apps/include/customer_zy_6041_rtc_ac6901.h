...
/*
GPIO SET:
	ADKEY-PB9	IR-PB3  PR0-OSC	TM1628:DAT_CLK_STB-PC3PC5PC4	
	AUX0-PA1PA2	 AUX1-PA3PA4	OPT_AUX2-PB11PB12	MIC-PB13	MUTE-PA11
	PA0-MIC_DET(H)  	SD1-PB0_DAT_PB1_CMD_PB2_CLK	

	key:mode  prev pp next  menu(micvol/micecho/rtc)
