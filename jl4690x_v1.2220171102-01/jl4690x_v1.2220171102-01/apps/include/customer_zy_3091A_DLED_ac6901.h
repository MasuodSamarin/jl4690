...
#define adk_10k_16key_mode_zy_rec

//--------------------------
#define support_bt_key_mode


#define ADK_USE_16KEY_MODE

#ifdef ADK_USE_16KEY_MODE
#define adkey_max_num	16
#if 1
#define PULL_UP_RESISTANCE 10   //上拉电阻
#define KEYF_RES 0   //PP  
#define KEYE_RES 0.47   //RECPLAY/REC 	 0.14
#define KEYD_RES 1    //0			 0.3
#define KEYC_RES 2  // MODE		0.55
#define KEYB_RES 3.3  // 1			0.81
#define KEYA_RES 4.2  // 2  		0.97
#define KEY9_RES 5.6  //  repeat		1.18
#define KEY8_RES 7.5  //   3  		1.41
#define KEY7_RES 10   //  next		1.65
#define KEY6_RES 12  //   4		1.80
#define KEY5_RES 15  //   prev		1.98
#define KEY4_RES 20 //	5		2.20
#define KEY3_RES 30 //	6		2.47
#define KEY2_RES 42 // 	7		2.66
#define KEY1_RES 62 //  	8		2.84
#define KEY0_NOKEY_RES 100	//  9 3v
#else
...
// BT-PA4  ELSE -PA3
#define PP_LED_USER_PA4PA3
#define SUPPORT_DOUBLE_LED
