...
#if  SYS_DEFAULT_VOL
#define SUPPORT_MAX_VOL_VAL  29  //00-31 JSUO ADD
#else 
...
#define adk_use_22k_6key_mode_gw
...
#define  PP_LED_USER_PC4PB13
#define  SUPPORT_GW_SLH_DOUBLE_LED
...
#define  FM_SCAN_MODE_2   // 20161129 add
