...
GPIO SET:
	...
	PC1-MUTE	PB13-MIC PB9-ADKEY PB3-IR	AUX0-PA1PA2	
	SD1-PB0_DAT_PB1_CMD_PB2_CLK	
	PB10-DAT	PB11-CLK	PB12-STB
	PT_CLK-PC0	PT_DAT-PB10 (外接dvd通讯用)
	PT2313: PIN9/13-AUX    PIN10/14-CD PIN11/15-MP3
	PC5 PC4 PC3 PC2-COM1-4
	PA15PA14PA11PA10PA9PA4PA3PA2PA1-SEG1-9
...
#define adk_10k_15key_mode_zy_rec_menu
...
#define KEYA_RES 4.3  //null  		1v
#define KEY9_RES 5.6 //menu		1.2
...
#endif
///---------------------------------------------
#define SUPPORT_3LINE_HZWY_PDVD
#ifdef SUPPORT_3LINE_HZWY_PDVD
#define PDVD_3LINE_DATA_CLK_STB_PB10PB11PB12
#endif
