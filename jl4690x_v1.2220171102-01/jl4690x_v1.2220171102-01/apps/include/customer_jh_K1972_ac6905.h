...
GPIO SET:
 ...
 PC5-IR  PC4-MUTE(H)  PB13-PPLED  PA4-RLED  PC3-GLED
 PB11-POWER(L 开)  PB10-DC_IN  PB9-BAT_DET  PB12-AUX_DET

-----------------------------------
FULL: G-LED-ON	
HALF:R-LED ON
未充电  低电量红灯快闪
休眠模式：绿灯慢闪烁（大概3秒闪烁一下），蓝灯熄灭
-----------------------------------


当电池充满时，是绿灯常亮

当电池充电时，没有充满的时候，是红色常亮
...
#define AC6905A_OFF_IO_JH  // USE  USB  AS  IO 
...
#define adk_use_22k_3key_mode
//#define adk_use_22k_4key_mode_hid
//#define adk_use_2k7_13key_mode_ty
//#define adk_10k_15key_mode_zy
//#define adk_22k_15key_mode_gw

//#define SUPPORT_BT_CALL_REJECT_AND_CALL_LAST_NO_IN_ONE_KEY // 回拨和拒接同一个键
//#define SUPPORT_HID_AND_VOL_IN_ONE_KEY
...
#define  SUPPORT_BT_PLAY_MUSIC_LIGHT
...
//        #define  pa_mute_use_pin_PA11_PA10    // pa_mute_use_pin_PR0 //
        #define  pa_mute_use_pin_PC4// pa_mute_use_pin_PR0 //
...
//#define    line_user_dacl  //DACL

// AUX DETECT SET
#define AUX_DETECT_EN      1
 #if  AUX_DETECT_EN
    #define  support_line_chack_user_pb12
...
//  #define support_line_chack_user_ad
#define SUPPORT_AUX_IN_WAKE_UP_STANDBY
  #define support_line_key_mode
#endif 
...
#define DETECT_EXTERNAL_BAT_USE_PB9
...
//低电红灯快闪   低电待机
#define SUPPORT_BAT_DETECT_LOW_POWER_MODE_7

#define SUPPORT_JH_BAT_DOUBLE_LED
#define JH_BAT_DOUBLE_LED_USB_PA4PC3  // PA4-R PC3-G

#define SUPPORT_JH_POWER_SWITCH_IO
#define POWER_SWITCH_IO_USE_PB11  
