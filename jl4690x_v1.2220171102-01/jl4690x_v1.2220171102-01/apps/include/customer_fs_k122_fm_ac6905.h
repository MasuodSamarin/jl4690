...
/*
GPIO SET:
	ADKEY-PB9	MIC CHECK-PC5 	LED-PC4	
	AUX-DACR		MIC-PB13	
...
#define adk_use_22k_10key_mode_fs
...
#define KEY8_RES 6.8 //mic
#define KEY7_RES 7.5  //
#define KEY6_RES 10  // prev
#define KEY5_RES 15  //
...
#define  PP_LED_USER_PB9_LOW
#define  PP_LED_USER_ADKEY
...
//#define amp_ab_d_user_PC4
//#define amp_ab_d_alway_is_low
//#define amp_ab_d_alway_is_high


//-------AMP  ONLY POWER ON SET------------------------
#define support_AMP_POWER_ON_SET
#ifdef support_AMP_POWER_ON_SET
#define AMP_POWER_ON_IO_PC14
#define AMP_POWER_ON_TIMER	5
//#define support_AMP_IO_ALWAY_HIGH
u8 bPowerOnAmpTimer;
#endif
//-------LINE DET---------------------------------------
...
#define MIC_CHECK_ENABLE	1
 ...
 #define  support_mic_check_user_PC5
