...
// 开机默认MP3 没media  进入bt   ，拔掉u盘进入nop  (line as  nop mode)
...
#define SUPPORT_SD_USB_RECPLAY

#define SUPPORT_REC_SHOW_TIME_BUG // SDK  NO SHOWTIME


#define SUPORT_MODE_KEY_REC_FILE_CHANGE
...
#define adk_10k_15key_mode_ty_rec
...
#define SUPPORT_OFF_AUX_MODE_VOICE     // OFF  LINE  MODE VOICE
