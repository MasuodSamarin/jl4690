...
GPIO SET:
	...
	AUX0-PA1PA2		AUX1-PA3PA4		MIC-PB13	MUTE-PA11
...
//#define LED_ID_4018N_8848  //大屏
#ifdef LED_ID_4018N_8848
#define LED_COM_MAX 7
#define LED_8NUMS 4
#define LED_8GRIDS 7
#define LED_ICON_NUMS 5
//#define LED_7PIN_REVERSE
...
#define adk_user_4_key_msj_rec_key

#define ADK_USE_10KEY_MODE


#ifdef ADK_USE_10KEY_MODE
#ifdef adk_user_4_key_msj_rec_key
#define PULL_UP_RESISTANCE 22   //上拉电阻22K
#define KEY9_RES 0   ///pp
#define KEY8_RES 24 //next/v+
#define KEY7_RES 36  // perv/v-
#define KEY6_RES 51  // mode
#define KEY5_RES 91  //rpt
#define KEY4_RES 100  //rpt
#define KEY3_RES 150  //
#define KEY2_RES 180  //
#define KEY1_RES 200  //
...
#define PULL_UP_RESISTANCE 22   //上拉电阻22K
#define KEY9_RES 0   ///pp
#define KEY8_RES 2 //rec
#define KEY7_RES 5.1  // stop
#define KEY6_RES 10  // mute/power
#define KEY5_RES 15  //eq
#define KEY4_RES 24  //next/v+
#define KEY3_RES 36  //perv/v-
#define KEY2_RES 51  //mode
#define KEY1_RES 91  //rpt
#define KEY0_NOKEY_RES 220 // 
#endif
...
#define IR_USE_MSJ_20DF_26KEY
#ifdef IR_USE_MSJ_20DF_26KEY
...
//  #define  support_mic_check_user_PA1
  #define  support_mic_check_user_PA3
...
#define DETECT_EXTERNAL_BAT_USE_PA4
//#define LED_SCREEN_SHOW_BAT_STATUS

#define SUPPORT_SMJ_BAT_THREE_LED
#define MSJ_BAT_THREE_LED_USB_PB12PB10PB9 
#define SUPPORT_BAT_DETECT_LOW_POWER_MODE_MSJ


//检测是否外接电源
#define support_ic_chack_dc_in
//#define chack_dc_in_user_PB10   
#define chack_dc_in_msj_user_PA2
...
//开关检测
#define support_sw_chack
#if defined support_sw_chack

#define support_sw_chack_user_PC5
//#define support_sw_chack_user_PB10


extern u8	 bPowerSwFlag;
extern bool bIcPowerDcDetFlag;
#endif
