...
/*
GPIO SET:
	IR-PA11 	PP_LED-PA4	REP_ONE_LED-PA9	REP_ALL_LED-PA10
	AUX0-PA1PA2		SD1-PB0_DAT_PB1_CMD_PB2_CLK	
	IOKEY:PP-PB11	MODE-PB8	PREV-PB10	NEXT-PB9	REPEAT-PB12
----------------NO USE----------------------------	
	MIC-PB13	PC5-TY_PP_LED
...
// repeat  swap  mode
#define adk_10k_15key_mode_zy_rec_bt111
...
#define support_io_scan_user_PB11PB10PB9PB8PB12
#define io_scnkey_jl2015bt_mode
#define adk_user_6_key_mode_bt1111
#endif 
...
//#define  PP_LED_USER_PA4
#define  PP_LED_USER_PA10
#define  SUPPORT_REPEAT_ON_ALL_USE_LED
#ifdef SUPPORT_REPEAT_ON_ALL_USE_LED
//#define REPEAT_ON_ALL_LED_IO_PA9PA10
#define REPEAT_ON_ALL_LED_IO_PA9PA4
#endif
