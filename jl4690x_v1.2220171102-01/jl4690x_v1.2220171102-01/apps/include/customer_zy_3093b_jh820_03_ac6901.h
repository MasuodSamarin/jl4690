...
//=================================================
// 1-VOL SET JSUO
#define SYS_DEFAULT_VOL        27      ///<非0表示使用默认音量
#if  SYS_DEFAULT_VOL

#else 

#define  SYS_VOL_MAX  30
#define  LED_SHOW_VOL_MAX  32

#define RESET_DEFAULT_VOL   25 
#define RESET_MIN_VOL             1
...
//#define LED_ID_HJ820_1 // SD-5029YPG
#define LED_ID_JH820_03
#define TM1628_MODE 0x03
//#define TM1628_DATA_CLK_STB_USE_PA15PA14PC0
#define TM1628_DATA_CLK_STB_USE_PC0PA14PA15
//#define TM1628_DATA_CLK_STB_USE_PC0PA15PA14
#define LED_COM_MAX 14
#define LED_8NUMS 4
#define LED_8GRIDS 7
#define LED_ICON_NUMS 7
 #define LED_EQ_NUMS  12


// #define SUPPORT_TM1628_KEY_READ
#ifdef SUPPORT_TM1628_KEY_READ
#define TM1628_SCAN_BYTE 4  //TM1628 MAXIMUM SCAN BYTE IS 5
#define LED_KEY_MAX 10
//#define LED_KEY_USE_ZY_J_M3_B_6KEY
#define LED_KEY_USE_ZY_HJ802_1_4KEY
//#define LED_KEY_USE_MSJ_2009_10KEY
#endif
...
//#define IR_ZY_THREE_GENERAL_HJ820_00FF_807F_01FE_27KEY
#define IR_ZY_THREE_GENERAL_JH820_00FF_807F_01FE_27KEY
