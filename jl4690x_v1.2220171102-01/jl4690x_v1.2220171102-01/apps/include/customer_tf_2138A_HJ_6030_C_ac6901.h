...
#define SUPPORT_TM1618_MODE
#ifdef SUPPORT_TM1618_MODE
#define TM1618_MODE 0x00
#define TM1618_DATA_CLK_STB_USE_PA15PC1PA14


#define LED_ID_6030_C_VFD
...
#define SUPPORT_STANBY_MODE_SHOW_____ /// 待定
...
#define PT2313_CLK_DATA_USE_PC5PA4
...
#define Aud_SwAC3			0x01		//Stereo 3
#define Aud_SwCD			0x03		//Stereo 3
#define Aud_SwVcd			0x03		//Stereo 3
#define Aud_SwNoting		0x03		//Stereo 4  *

#define support_main_vol_max_show_99
#define MAIN_VOL_MAX         99
#define VOLUME_DEFUALT       70
#define SWVOL_DEFUALT        70
#define  FLFR_DEFUALT           28  //这个 值是设 左右喇叭的 起始值  软件内没有减价这个值  如果音量过大可以减小这个值  最大31 
#define BASS_DEFAULT 7
#define TREBLE_DEFAULT 9

#define SUPPORT_PT2313_MAIN_VOL_SW_VOL_SAMETIME_ADJUST
//#define support_mian_vol_bassvol_add
...
#define M62429_CLK_DATA_USE_PA3PA4
//#define M62429_CLK_DATA_USE_PPB9PA4
