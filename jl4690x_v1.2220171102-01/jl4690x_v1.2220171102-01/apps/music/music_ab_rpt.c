...
static u32 save_break_point(MUSIC_OP_API* m_op_api, void* buf)
{
    ...
    memcpy(&bp_p->inf.brk_buff,(u8 *)(dec_api->phy_ops->dec_ops->get_bp_inf(dec_api->phy_ops->dc_buf)),dec_api->bp_size);
    bp_p->inf.crc=CRC16((u8*)&bp_p->inf.brk_buff,VM_FILE_BK_LEN-2);
