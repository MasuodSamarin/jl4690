...
void irtc_hw_init(void)
{
    ...
    PORTR_DIR(PORTR0 , 1);
    PORTR_DIE(PORTR0 , 1);*/
    rtc_module_on(WAKE_UP_ENABLE, RTC_CLK_CHECK_EN,  rtc_isr_user_handler);
...
//        tone_play_by_name(RTC_TASK_NAME, 1,  BPF_RTC_MP3);
            os_taskq_post_msg(RTC_TASK_NAME, 1, SYS_EVENT_PLAY_SEL_END); //触发AUX模块初始化
