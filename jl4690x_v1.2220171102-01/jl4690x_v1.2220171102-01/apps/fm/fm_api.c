...
//	 printf("-------fm_mode_var->wTotalChannel--------%d\n",fm_mode_var->wTotalChannel);		
#ifdef SUPPORT_FM_PRESET_STATION

// 内置3个电台93.6，100.5和105.2，
    if(!fm_mode_var->wTotalChannel)
    {

	fm_mode_var->wFreq=936;
        fm_info->dat[FM_FRE] = fm_mode_var->wFreq - MIN_FRE;	
        save_fm_point(fm_mode_var->wFreq - MIN_FRE);
		
	fm_mode_var->wFreq=1005;
        fm_info->dat[FM_FRE] = fm_mode_var->wFreq - MIN_FRE;
        save_fm_point(fm_mode_var->wFreq - MIN_FRE);

	fm_mode_var->wFreq=1052;
        fm_info->dat[FM_FRE] = fm_mode_var->wFreq - MIN_FRE;
        save_fm_point(fm_mode_var->wFreq - MIN_FRE);		
