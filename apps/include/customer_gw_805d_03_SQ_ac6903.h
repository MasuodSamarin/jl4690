...
#define adk_22k_15key_mode_gw_sq
// 上一曲:4K7 播放暂停:10欧 下一曲:3K3   转换:5K6
...
#define KEYD_RES 1 	 //  
#define KEYC_RES 2  	 //  
#define KEYB_RES 3.3 // next
#define KEYA_RES 4.7  //  prev 		
#define KEY9_RES 5.6 //  mode
#define KEY8_RES 10 //  pp
#define KEY7_RES 12   //   
#define KEY6_RES 18  //   -
#define KEY5_RES 24  //  	
#define KEY4_RES 36 //  
...
#define  FM_SCAN_MODE_1   // 20161129 add
