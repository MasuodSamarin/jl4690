...
/*
GPIO SET:
	ADKEY-PB7	IR-PC5 	LED-PC4	
	AUX-pa3pa4 aux1		MIC/MUTE-PB13
...
#if  SYS_DEFAULT_VOL
#define SUPPORT_MAX_VOL_VAL  27  //00-31 JSUO ADD
#else 
...
#if EARPHONE_MODE_EN
	#define CHARGE_POWER_OFF 	1               ///充电是否关机
...
#define adk_10k_15key_mode_zy_mm_voice

#ifdef adk_10k_15key_mode_zy_mm
#define SUPPORT_MUSIC_FOLDER_OPERATION // folder prev next repeat key
#endif


//PLAY/PAUSE	电阻值:2K4		FOL+	电阻值:47K	
//NEXT/VOL+	电阻值:16K			MODE	电阻值:4K3	
//PREV/VOL-	电阻值:27K			EQ	电阻值:0R		
//VOL+	电阻值:6K6				REPEAT	电阻值:1K2	
//VOL-	电阻值:10K				STOP	电阻值:91K	
...
//#define IR_USE_DOUBLE_ZY2119_00FF_SM_807F_25KEY
//#define IR_USE_DOUBLE_ZY2119_00FF_SM_BT_807F_25KEY

#define IR_ZY_THREE_GENERAL_YK2119_00FF_807F_01FE_25KEY_VOICE
...
#ifdef IR_USE_DOUBLE_ZY2119_00FF_SM_BT_807F_25KEY
#define SUPPORT_MUSIC_FOLDER_OPERATION // folder prev next repeat key
#define support_fm_key_mode
#define support_music_key_mode
#define support_bt_key_mode
...
//        #define  pa_mute_use_pin_PA11_PA10    // pa_mute_use_pin_PR0 //
        #define  pa_mute_use_pin_PB13 // pa_mute_use_pin_PR0 //
...
#define SUPPORT_AUX_MAX_VOL_DEC  // aux  max vol dec 1
#define SUPPORT_BT_AUTO_BACK_CONNECT
...
#define SUPPORT_FM_OPTION_VOICE 1 // PREV NEXT SEARCH SEARCH_END vol+- mute v_on v_off
#define SUPPORT_LINE_OPTION_VOICE 1 // PREV NEXT SEARCH SEARCH_END vol+- mute v_on v_off
#define SUPPORT_TY_VOICE 	0 // BT_MUSIC(PREV NEXT PLAY PAUSE    repeatone MICON MICOFF ) 
#define SUPPORT_VOICE_NUMBER 1
#define SUPPORT_MUTE_VOICE 
#define SUPPORT_EQ_VOICE 0
#define SUPPORT_VOL_VOICE 0
//#define SUPPORT_BT_PLAY_PAUSE_VOICE 
//#define SUPPORT_MIC_ONOFF_VOICE
//#define SUPPORT_POWER_ON_TONE
#if defined SUPPORT_POWER_ON_TONE
bool  bPowerOnVoiceFlag;
#endif
#define SUPPORT_VOICE_OFF_BT_USE_TY_VOICE 
#define SUPPORT_BT_NO_USE_PREV_NEXT_VOICE   // off bt mode  prev next  voice
//#define LED_SHOW_ONOFF
#define SUPPORT_DOUBLE_VOICE_AND_NOTICE  // ch+en+notice
#define SUPPORT_VOICE_ENALBE_MEM
#define SUPPORT_VOICE_ONOFF_KEY_SINGLE_KEY // voice on off key
#define SUPPORT_DOUBLUE_VOICE_CHANGE_KEY // EN CH change key
#ifdef SUPPORT_VOICE_ONOFF_KEY_SINGLE_KEY
extern u8 bStoreVoiceVal;
#endif
...
#define BT_PROMPT_EN
#define FM_PROMPT_EN
#define POWER_ON_VOICE_DEFAULT	1  //0-OFF  1-ch	2-en
...
// eq normal  adjust
#define SUPPORT_MUSIC_EQ_ADJUST

#define SUPPORT_BT_FIRST_CONNECT_AUTO_PLAY
