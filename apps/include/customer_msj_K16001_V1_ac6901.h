...
//=================================================
// 1-VOL SET JSUO
#define SYS_DEFAULT_VOL        29      ///<非0表示使用默认音量
#if  SYS_DEFAULT_VOL
#else 
...
#define support_led7_user_pc0pa14pa15pc1pc2pc3pc4_low
...
#define LED_ID_4018N_2_SCG
#ifdef LED_ID_4018N_2_SCG
#define LED_COM_MAX 7
#define LED_8NUMS 4
#define LED_8GRIDS 7
#define LED_ICON_NUMS 7
...
#define support_aux_led_disp_aux
...
#define adk_10k_15key_mode_scg_rec
...
#ifdef IR_USE_DOUBLE_ZY2119_00FF_807F_22KEY
...
#define IR_USE_SCG_DOUBLE_ZY2119_00FF_807F_22KEY
#ifdef IR_USE_SCG_DOUBLE_ZY2119_00FF_807F_22KEY
...
#define AUTO_VOL_SET_DEC  10

//#define MIC_CHECK_OUT_VOL_X_STEP


#define MIC_CHECK_TIMER 2
...
#define SUPPORT_MUSIC_ALWAY_FIRST_PLAY_USE_MODE
...
#define SUPPORT_SCG_VOICE 	1 // BT_MUSIC(PREV NEXT PLAY PAUSE    repeatone MICON MICOFF ) 
