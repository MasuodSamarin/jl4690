...
// 7k5-bt
#define adk_10k_15key_mode_zy_rec_voice_yh
...
#define IR_ZY_THREE_GENERAL_YK2119_00FF_VKK15L_807F_01FE_7F00_31KEY
...
#define SUPPORT_MODE_VOICE_EN_CH_ONOFF
#ifdef SUPPORT_MODE_VOICE_EN_CH_ONOFF
extern u8 bModeVoiceSelVal; //0-off  1-ch  2-en
extern u8 bStoreModeVoiceSelVal; //0-off  1-ch  2-en
#define POWER_ON_VOICE_DEFAULT	1  //0-OFF  1-CH	2-EN
#define LED_SHOW_ONOFF
#define SUPPORT_MUSIC_PREV_NEXT_VOICE
#define SUPPORT_PP_PREV_NEXT_VOICE
#define SUPPORT_MUSIC_REPEAT_VOICE
#define SUPPORT_MUSIC_EQ_VOICE
#endif
