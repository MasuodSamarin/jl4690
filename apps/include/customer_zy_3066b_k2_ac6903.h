...
20170103  --	key ad value  customer  set
k2:MODE:51K    PREV:36K   P/P:0R  NEXT:24K
...
// k2:MODE:51K    PREV:36K   NEXT:24K  P/P:0R 
#define adk_10k_15key_mode_zy_k2
...
#define KEYD_RES 1 	 //next/ff	0.3
#define KEYC_RES 2  	 //prev/fr	0.55
#define KEYB_RES 3.3 //mode		0.8
#define KEYA_RES 4.7  //null  		1v
#define KEY9_RES 5.6 //v+		1.2
...
//#define FM_SCAN_MODE_1  //  29 station 
#define FM_SCAN_MODE_2  //  29 station 
