...
// 10s 检测一次 连续3次变化
#define SUPPORT_BAT_DET_TIMER_ADJUST_TIANYIN
...
#define  SUPPORT_LOW_POWER_TONE 1
...
#define SUPPORT_EXTERN_POWER_FM_MUTE_IO
#ifdef SUPPORT_EXTERN_POWER_FM_MUTE_IO
#define EXTERN_POWER_FM_MUTE_IO_USB_PA3
