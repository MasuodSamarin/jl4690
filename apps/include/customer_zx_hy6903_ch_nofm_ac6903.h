...
#define KEYD_RES 1 	 // 10+
#define KEYC_RES 2  	 //  
#define KEYB_RES 3.3 // rec
#define KEYA_RES 6.2  //prev/v-
#define KEY9_RES 9.1 // next/v+
#define KEY8_RES 15 // recplay
#define KEY7_RES 18   //   
...
//  POWER MUTE  SWAP 
 #define IR_USE_DOUBLE_TY_00FF_807F_22KEY_ZX
