...
// 20170116 ADD	
//--------------------------------------------------------
	PA4-M62429PIN5_CLK  PA3-M62429PIN4_DAT  m62429_in-pin1.2
	PC4PC3-ENCORD_VOL	 PC2PC1-ENCORD_M62429_VOL
4	遥控器用30CF用户码这个，
	把42码值这个键功能改为OK VOL-，
	把0F码值这个键功能改为OK VOL+。
	其他不变	
6	按键增加10+（5.6K），STOP（33K）其他功能不变
//--------------------------------------------------------
...
#define RESET_DEFAULT_VOL   18 
#define RESET_MIN_VOL            6
#endif 
...
//#define support_aux_led_disp_line     //屏上显示"LINE"  7g8 ""LINE IN"
#define support_aux_led_disp_only_line     //7G8 屏上显示"LINE"
...
#define IR_TY_THREE_GENERAL_TY_00FF_HD7369_807F_30CF_29KEY_ECHO
#ifdef IR_TY_THREE_GENERAL_TY_00FF_HD7369_807F_30CF_29KEY_ECHO
//-------------------------------------------
...
#define KARAOKE_MIC_DEFAULT_VOL		10
