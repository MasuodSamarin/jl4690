...
void key_msg_register(char *task_name,const u8 led_key_t[4][LED_KEY_MAX],const u8 ad_key_t[4][adkey_max_num],const u8 io_key_t[4][10],
                      const u8 ir_key_t[4][ir_max_num], const u8 touch_key_t[4][10]);

#elif defined(ir_max_num) &&  defined (adkey_max_num)
void key_msg_register(char *task_name,const u8 ad_key_t[4][adkey_max_num],const u8 io_key_t[4][10],
                      const u8 ir_key_t[4][ir_max_num], const u8 touch_key_t[4][10]);
...
extern void menu_key_msg_register(char *task_name,u8 *menu_key_msg);
