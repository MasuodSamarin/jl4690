...
#ifndef support_only_rec_key_to_rec_mode
...
bool  muisc_to_rec_flag;

u32 rec_is_online(void)
{
    return (file_operate_get_total_phydev()&&muisc_to_rec_flag);  //有USB SD 并且是MUSIC REC 按键
}
const struct task_dev_info rec_task_2_dev =
{
    .name = "RECTask",
    .dev_check = rec_is_online ,
};
