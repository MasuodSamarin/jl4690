...
{
#ifdef DEC_TYPE_SBC_ENABLE
    (void*)get_sbcd_ops,
#endif

#ifdef DEC_TYPE_WAV_ENABLE
    (void*)get_wav_ops,
#endif

#ifdef DEC_TYPE_WMA_ENABLE
    (void*)get_wma_ops,
#endif

#ifdef DEC_TYPE_AAC_ENABLE
    (void*)get_aac_ops,
#endif
...
#ifdef DEC_TYPE_MP3_ENABLE
    (void*)get_mp3_ops,
#endif

#ifdef DEC_TYPE_F1A_ENABLE
    (void*)get_f1a_ops,
#endif
};
...
//    file_operate_ctl(FOP_GET_FOLDER_INFO,m_op_api->fop_api,&music_cur_filetotal,&music_cur_filenum);
    ...
    if((music_cur_filenum>rec_file_startcnt)&&(music_cur_filenum<=rec_file_endcnt))
...
#if 0//def SUPPORT_RECPLAY_STATE
		

    if(strstr(music_name_buf.tpath,"/JL_REC")!=NULL)
		bIfRecordFolder=TRUE;
	else
		bIfRecordFolder=FALSE;
...
#if REC_EN
u16 rec_file_startcnt=0;
u16 rec_file_endcnt=0;
#endif 
