...
#define MAX_SYS_VOL_L         32      ///<系统主音量级数
...
#define FM_DIGITAL_VOL_MAX_L     31      ///<数字通道最大音量调节级数
#define FM_DIGITAL_VOL_MAX_R     31
#define FM_ANALOG_VOL_MAX_L      31      ///<模拟通道最大音量调节级数
#define FM_ANALOG_VOL_MAX_R      31


#define MP3_DIGITAL_VOL_MAX_L     31      ///<数字通道最大音量调节级数
#define MP3_DIGITAL_VOL_MAX_R     31
#define MP3_ANALOG_VOL_MAX_L      31      ///<模拟通道最大音量调节级数
#define MP3_ANALOG_VOL_MAX_R      31


#define BT_DIGITAL_VOL_MAX_L     31      ///<数字通道最大音量调节级数
#define BT_DIGITAL_VOL_MAX_R     31
#define BT_ANALOG_VOL_MAX_L      31      ///<模拟通道最大音量调节级数
#define BT_ANALOG_VOL_MAX_R      31


#define AUX_DIGITAL_VOL_MAX_L     31      ///<数字通道最大音量调节级数
#define AUX_DIGITAL_VOL_MAX_R     31
#define AUX_ANALOG_VOL_MAX_L      27      ///<模拟通道最大音量调节级数
...
#define MP3_DIGITAL_VOL_MAX_L     27      ///<数字通道最大音量调节级数
#define MP3_DIGITAL_VOL_MAX_R     27
#define MP3_ANALOG_VOL_MAX_L      27      ///<模拟通道最大音量调节级数
...
#define AUX_DIGITAL_VOL_MAX_L     31      ///<数字通道最大音量调节级数
#define AUX_DIGITAL_VOL_MAX_R     31
#define AUX_ANALOG_VOL_MAX_L      31      ///<模拟通道最大音量调节级数
...
#else
#define FM_DIGITAL_VOL_MAX_L     26      ///<数字通道最大音量调节级数
#define FM_DIGITAL_VOL_MAX_R     26
#define FM_ANALOG_VOL_MAX_L      26      ///<模拟通道最大音量调节级数
#define FM_ANALOG_VOL_MAX_R      26


#define MP3_DIGITAL_VOL_MAX_L     25      ///<数字通道最大音量调节级数
#define MP3_DIGITAL_VOL_MAX_R     25
#define MP3_ANALOG_VOL_MAX_L      25      ///<模拟通道最大音量调节级数
#define MP3_ANALOG_VOL_MAX_R      25


#define BT_DIGITAL_VOL_MAX_L     26      ///<数字通道最大音量调节级数
#define BT_DIGITAL_VOL_MAX_R     26
#define BT_ANALOG_VOL_MAX_L      26      ///<模拟通道最大音量调节级数
#define BT_ANALOG_VOL_MAX_R      26


#define AUX_DIGITAL_VOL_MAX_L     26      ///<数字通道最大音量调节级数
#define AUX_DIGITAL_VOL_MAX_R     26
#define AUX_ANALOG_VOL_MAX_L      26      ///<模拟通道最大音量调节级数
...
#if SYS_DEFAULT_VOL==32
#define DIGITAL_VOL_MAX_L     33      ///<数字通道最大音量调节级数
...
#ifdef lineI_user_PAaPA2
#define LINEIN_CHANNEL_1     DAC_AMUX0
#else
